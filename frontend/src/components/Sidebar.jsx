...
import {
    ...
    LogOut, Sun, Moon, ChevronRight, Briefcase, HelpCircle, Bell, Settings, X
} from 'lucide-react';
import { useAuth } from '../context/useAuth';
import { useTheme } from '../context/ThemeContext';
import toast from 'react-hot-toast';

const Sidebar = ({ navItems, onTourStart, isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
                <div className="mobile-only" style={{ position: 'absolute', top: '20px', right: '20px' }}>
